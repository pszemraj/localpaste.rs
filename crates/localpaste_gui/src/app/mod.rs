...
#[doc = "Default initial window size for native GUI startup."] pub(crate) const DEFAULT_WINDOW_SIZE: [f32; 2] = [1100.0, 720.0];
#[doc = "Minimum enforced window size to keep sidebar/editor controls usable."] pub(crate) const MIN_WINDOW_SIZE: [f32; 2] = [900.0, 600.0];
const HIGHLIGHT_PLAIN_THRESHOLD: usize = 256 * 1024;
const SEARCH_DEBOUNCE: Duration = Duration::from_millis(150);
const PALETTE_SEARCH_LIMIT: usize = 40;
#[doc = "Per-line render cap used by preview/virtual editor galleys."] pub(crate) const MAX_RENDER_CHARS_PER_LINE: usize = 10_000;
