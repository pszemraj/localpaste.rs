...
- [`../crates/localpaste_core`](https://github.com/pszemraj/localpaste.rs/tree/main/crates/localpaste_core): config, models, storage, transaction helpers, invariants.
- [`../crates/localpaste_server`](https://github.com/pszemraj/localpaste.rs/tree/main/crates/localpaste_server): Axum routing, middleware, handlers, embedded server helper.
- [`../crates/localpaste_gui`](https://github.com/pszemraj/localpaste.rs/tree/main/crates/localpaste_gui): native app shell, backend worker, editor flows.
- [`../crates/localpaste_cli`](https://github.com/pszemraj/localpaste.rs/tree/main/crates/localpaste_cli): HTTP client and endpoint discovery logic.
- [`../crates/localpaste_tools`](https://github.com/pszemraj/localpaste.rs/tree/main/crates/localpaste_tools): test data generation and repo hygiene checks (`check-loc`, `check-ast-dupes`).
...
[storage.md](https://github.com/pszemraj/localpaste.rs/blob/main/docs/storage.md).
...
- [dev/locking-model.md](https://github.com/pszemraj/localpaste.rs/blob/main/docs/dev/locking-model.md)
...
[language-detection.md](https://github.com/pszemraj/localpaste.rs/blob/main/docs/language-detection.md).
...
- Virtual-editor async highlight debounce/staging/patch behavior is defined in [language-detection.md](https://github.com/pszemraj/localpaste.rs/blob/main/docs/language-detection.md#virtual-editor-async-highlight-flow).
...
- [dev/devlog.md](https://github.com/pszemraj/localpaste.rs/blob/main/docs/dev/devlog.md)
- [dev/gui-notes.md](https://github.com/pszemraj/localpaste.rs/blob/main/docs/dev/gui-notes.md)
- [dev/gui-perf-protocol.md](https://github.com/pszemraj/localpaste.rs/blob/main/docs/dev/gui-perf-protocol.md)
...
- Engineering backlog: [dev/backlog.md](https://github.com/pszemraj/localpaste.rs/blob/main/docs/dev/backlog.md)
- GUI perf validation protocol: [dev/gui-perf-protocol.md](https://github.com/pszemraj/localpaste.rs/blob/main/docs/dev/gui-perf-protocol.md)
