...
- [docs/dev/locking-model.md](dev/locking-model.md)
...
- Virtual-editor async highlight debounce/staging/patch behavior is defined in [docs/language-detection.md](language-detection.md#virtual-editor-async-highlight-flow).
...
- [AGENTS.md](../AGENTS.md)
- [docs/dev/devlog.md](dev/devlog.md)
...
- GUI perf validation protocol: [docs/dev/gui-perf-protocol.md](dev/gui-perf-protocol.md)
