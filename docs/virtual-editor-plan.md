...
- ✅ Chunked highlight caching + chunk galley reuse are live behind the existing TextEdit, delivering milestones 1 & 2.
- 🧪 Set LOCALPASTE_VIRTUAL_PREVIEW=1 to render a read-only chunk-virtualized preview using the new caches—useful for measuring scroll performance ahead of the full virtual editor.
