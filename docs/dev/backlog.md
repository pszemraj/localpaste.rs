...
- [ ] Complete manual newline-burst highlight perf recheck (per [gui-perf-protocol.md](docs/dev/gui-perf-protocol.md)), capture refreshed perf evidence in release notes, and decide gate flip from `p95 <= 25 ms` to `p95 <= 16 ms`.
