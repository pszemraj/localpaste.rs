...
For any concept, keep one primary definition and replace duplicate prose elsewhere with a short link.
...
- Put normative procedures in the primary doc for that topic.
- Keep non-primary docs concise and link back to primary docs.
